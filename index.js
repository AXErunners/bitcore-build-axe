...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-axe/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-axe -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-axe -o bitcore-lib-axe.js';
    }
